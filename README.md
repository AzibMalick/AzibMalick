...
|---|---|---|
| [❤️ Cardiovascular Disease Prediction](https://github.com/AzibMalick/Cardiovascular-Disease-Prediction) | Python, Random Forest, scikit-learn | **96.5% accuracy** |
| [🧠 Mental Health Risk Prediction](https://github.com/AzibMalick/Predicting-Mental-Health) | Python, XGBoost, OSMI data | **81% accuracy** |
| [🫀 Liver Disease Prediction](https://github.com/AzibMalick/Liver-Disease-Prediction) | Python, scikit-learn | **High recall — tuned for sensitivity** |
| [🎗️ Breast Cancer Classification](https://github.com/AzibMalick/Predicting-Breast-Cancer) | Python, scikit-learn | **Low false negative rate** |

---

## 🏥 Clinical background

**JPMC Karachi** · Biomedical Intern · Mar–Apr 2025
> Maintained ventilators, ICU monitors, ECG machines. Fault logging in high-dependency units.

**Abbasi Shaheed Hospital** · Biomedical Intern · Aug–Sep 2024
> Device performance checks across emergency and in-patient wards.
